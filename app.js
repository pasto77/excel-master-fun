        ...
        li.onclick = () => {
            ...
            if (item && item.quiz) {
                display.innerHTML = `
                    ...
                    <button id="btn-quiz">Vérifier</button>
                    <p id="feedback" style="margin-top:15px; font-weight:bold;"></p>
                `;
                document.getElementById('btn-quiz').onclick = () => {
                    const val = document.getElementById('quiz-input').value.toUpperCase();
                ...
                display.innerHTML = `
                    ...
                    <button onclick="document.getElementById('feedback').textContent='${item.r}'">Valider</button>
