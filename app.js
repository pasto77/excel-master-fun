document.addEventListener('DOMContentLoaded', () => {
    ...
    // CHARGEMENT DE LA MÉMOIRE : On récupère les chapitres déjà réussis
    ...
    const content = {
        ...
        13: { t: "Nettoyage : Les Doublons", c: "Supprimer les répétitions inutiles.", a: "Nettoyer", r: "+20 XP" },
        ...
        16: { t: "Figer les Volets", c: "Garder les titres visibles.", a: "Figer", r: "+20 XP" },
        17: { t: "Mise en forme Conditionnelle", c: "Colorer selon la valeur.", a: "Colorer", r: "+30 XP" },
        18: { t: "Protection", c: "Onglet pour verrouiller une feuille ?", quiz: true, answer: "Révision", r: "Sécurité activée. +40 XP" },
        19: { t: "Somme SI", c: "Somme de A1:A10 si > 100 ?", quiz: true, answer: '=SOMME.SI(A1:A10;">100")', r: "+70 XP" },
        ...
        23: { t: "Fusionner : CONCAT", c: "Coller le texte de A1 et B1 ?", quiz: true, answer: "=CONCAT(A1;B1)", r: "+50 XP" },
        24: { t: "Nettoyage : Espaces", c: "Supprimer les espaces inutiles ?", quiz: true, answer: "=SUPPRESPACE(A1)", r: "+50 XP" },
        25: { t: "Majuscules", c: "Mettre A1 en majuscules ?", quiz: true, answer: "=MAJUSCULE(A1)", r: "+30 XP" },
        26: { t: "Trouver la position", c: "Chercher la position d'un texte ?", quiz: true, answer: "=TROUVE(A1)", r: "+60 XP" },
        27: { t: "Remplacer du texte", c: "Changer un mot par un autre ?", quiz: true, answer: "=SUBSTITUE(A1)", r: "+60 XP" },
        28: { t: "Nombre de caractères", c: "Compter la longueur du texte ?", quiz: true, answer: "=NBCAR(A1)", r: "+40 XP" },
        29: { t: "Convertir en nombre", c: "Transformer du texte en chiffre ?", quiz: true, answer: "=VALEUR(A1)", r: "+50 XP" },
        ...
        32: { t: "La fonction ET", c: "A1 > 0 ET B1 < 100 ?", quiz: true, answer: "=ET(A1>0;B1<100)", r: "+50 XP" },
        33: { t: "La fonction OU", c: "A1 = 'OUI' OU 'YES' ?", quiz: true, answer: '=OU(A1="OUI";A1="YES")', r: "+50 XP" },
        ...
        37: { t: "SOMMEPROD", c: "Total (Prix * Qté) sans colonne ?", quiz: true, answer: "=SOMMEPROD(A1:A10;B1:B10)", r: "+90 XP" },
        38: { t: "Gestion des dates", c: "Dernier jour du mois de A1 ?", quiz: true, answer: "=FIN.MOIS(A1;0)", r: "+70 XP" },
        39: { t: "Calcul de l'âge", c: "Extraire l'année actuelle ?", quiz: true, answer: "=ANNEE(AUJOURDHUI())", r: "+60 XP" },
        40: { t: "EXAMEN : Niveau 4", c: "Combiner ET/OU est une logique... ?", quiz: true, answer: "Booléenne", r: "Niveau 4 validé ! +300 XP" },
        41: { t: "Intro aux Macros", c: "Langage des macros Excel ?", quiz: true, answer: "VBA", r: "+50 XP" },
        42: { t: "Enregistreur", c: "Onglet secret pour les macros ?", quiz: true, answer: "Développeur", r: "Activé ! +40 XP" },
        43: { t: "Extensions", c: "Fichier Excel avec macros ?", quiz: true, answer: ".xlsm", r: "+40 XP" },
        44: { t: "Sécurité", c: "Alerte jaune à l'ouverture ?", quiz: true, answer: "Avertissement de sécurité", r: "+30 XP" },
        45: { t: "Premier script", c: "VBA pour un message ?", quiz: true, answer: "MsgBox", r: "Codeur ! +100 XP" },
        46: { t: "VBA : Variables", c: "Déclarer 'Nom' en texte ?", quiz: true, answer: "Dim Nom As String", r: "+60 XP" },
        47: { t: "VBA : Boucles", c: "Répéter une action ?", quiz: true, answer: "For Each", r: "+80 XP" },
        48: { t: "Power Query", c: "Nettoyer des données externes ?", quiz: true, answer: "Power Query", r: "+70 XP" },
        49: { t: "Analyse Scénario", c: "Trouver la valeur cible ?", quiz: true, answer: "Valeur cible", r: "+60 XP" },
    ...
    function updateProgressBar() {
        ...
        // SAUVEGARDE RÉELLE : On enregistre dans le navigateur
    ...
    for (let i = 1; i <= 50; i++) {
        ...
        // Si le chapitre était déjà réussi, on applique le style visuel
